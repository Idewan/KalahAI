...
class Trainer():
    ...
    def __init__(self, game, net):
        self.game = game
        self.net = net
        # the memory with our training examples
        ...
        self.mcts_sims = 25
        # initialize the net of the opponent
        self.opp_nnet = KalahNetTrain(game, BATCH_SIZE, DEVICE, EPOCHS, LR, DROPOUT)
        # threshold for changing to new policy
        self.threshold = 0.55
    ...
    def policyIter(self):
        ...
        for i in range(self.num_iters):
            ...
            # current MCTS after training
            curr_mcts = MCTS(self.game, self.net)

            # create Arena where the two agents can play against each other
            # the lambda functions take the action that maximizes the probability after MCTS
    ...
    def executeEpisode(self):
        ...
        while True:
            ...
            # make move according to action from MCTS probabilities
